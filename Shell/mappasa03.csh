...
#
awk '{print $1,$2,$3}' ../Output/shakemapsa03.dat | surface -Gdata.grd -R$Longmin/$Longmax/$Latmin/$Latmax -I$dig -T$Tens  
...
grdcontour data.grd -JM -R -B -CcontourSA03.dat -A -W4 -O -K -V >> test.ps
...
#
pstext ../Parametri/earthquake.info-sa03 -Jm0.5 -R0/50/0/20 -O -P -V -Y10.0 >> test.ps
#
ps2epsi test.ps test.epsi 
convert test.epsi Sa03.png 
/bin/mv Sa03.png ../Mappe/.
/bin/mv test.ps ../Mappe/Sa03.ps
gzip -f ../Mappe/Sa03.ps
/bin/rm *.grd
/bin/rm pippo* 
#
#gs -sDEVICE=x11 ../Mappe/Sa03.ps
