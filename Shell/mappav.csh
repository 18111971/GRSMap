...
nc=`awk '{print $1}' contourPGV.dat`
na=`awk '{print $2}' contourPGV.dat`
...
#
awk '{print $1,$2,$3}' ../Output/shakemapvel.dat | surface -Gdata.grd -R$Longmin/$Longmax/$Latmin/$Latmax -I994+/580+ -T$Tens  
#
...
#
#grdcontour data.grd -JM18 -Ba10mf5m/a10mf5mWSen -C0.1 -R -V -K -Y8 -X3 -P > test.ps
...
#psxy ../VS30/Tabella_VS30.dat -JM -R -B -Sc.25 -W2 -G255/255/0 -M -O -K >> test.ps
