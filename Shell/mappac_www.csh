...
#
awk '{if($3<0.01)$3=0.01;print $1,$2,$3}' ../Output/shakemapacc.dat | surface -Gdata.grd -R$Longmin/$Longmax/$Latmin/$Latmax -I$dig -T$Tens  
#
...
grdview data.grd -JM14.25 -Ba60mf30m/a30mf30mWSen -C../Palette/pal_pga_da_Imm -Qs -N0/255/255/255 -Jz0.5e-03 -R -V -I../GMT/ombra.grd -K -Y8 -X3 -P > test.ps
psxy ../GMT/camp_bas_sep_wgs.txt -R -B -JM -O -Sc.02 -G125 -K >> test.ps
pscoast -Lf$scx/$scy/$scy/50 -JM -R -B -K -S120/160/220 -W4/0/0/0 -Dh -O >> test.ps 
