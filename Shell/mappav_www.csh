...
awk '{if($3<0.01)$3=0.01;print $1,$2,$3}' ../Output/shakemapvel.dat | surface -Gdata.grd -R$Longmin/$Longmax/$Latmin/$Latmax -I$dig -T$Tens  
#
#grdview data.grd -JM14.25 -C../Palette/newpalpgag -Qs -N0/255/255/255 -Jz0.5e-03 -R -V -I../GMT/ombra.grd -K -Y8 -X3 -P > test_trans.ps
#grdview data.grd -JM14.25 -C../Palette/palpga1 -Qs -N0/255/255/255 -Jz0.5e-03 -R -V -K -Y8 -X3 -P > test_trans.ps
grdview data.grd -JM14.25 -C../Palette/pal_pgv_da_Imm -Qs -N0/255/255/255 -Jz0.5e-03 -R -V -K -Y8 -X3 -P > test_trans.ps
pscoast -JM -R -S255/255/255 -W1,0/0/0,. -Di -O >> test_trans.ps
...
/bin/mv test_trans.png ../Mappe/PGV_trans_color.png
...
#grdview data.grd -JM14.25 -Ba60mf30m/a30mf30mWSen -C../Palette/newpalpgvcs -Qs -N0/255/255/255 -Jz0.5e-03 -R -V -I../GMT/ombra.grd -K -Y8 -X3 -P > test.ps
grdview data.grd -JM14.25 -Ba60mf30m/a30mf30mWSen -C../Palette/pal_pgv_da_Imm -Qs -N0/255/255/255 -Jz0.5e-03 -R -V -I../GMT/ombra.grd -K -Y8 -X3 -P > test.ps
...
pstext ../Parametri/earthquake.info-pgv -Jm0.5 -R0/50/0/20 -O -P -V -Y10.5 >> test.ps
#
bboxx -insert test.ps
bboxx -insert test.ps
sed -i 's/%%HiResBoundingBox:.*//' test.ps
convert test.ps PGV_color.png
/bin/mv PGV_color.png ../Mappe/.
/bin/mv test.ps ../Mappe/PGV_color.ps
gzip -f ../Mappe/PGV_color.ps
rm -f test.ps*
/bin/rm *.grd
/bin/rm pippo*
#
