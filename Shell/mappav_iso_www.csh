...
awk '{print $1,$2,$4}' ../Output/mappa-iso-pgx.dat | surface -Gdata.grd -R$Longmin/$Longmax/$Latmin/$Latmax -I0.01 -T$Tens  
#
...
grdcontour data.grd -JM -R -B -CcontourPGV.dat -A -W4 -O -K -V >> test.ps
