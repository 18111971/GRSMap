...
#
awk '{print $1,$2,$3}' ../Output/shakemapsa3.dat | surface -Gdata.grd -R$Longmin/$Longmax/$Latmin/$Latmax -I$dig -T$Tens  
...
grdcontour data.grd -JM -R -B -CcontourSA3.dat -A -W4 -O -K -V >> test.ps
...
#
pstext ../Parametri/earthquake.info-sa3 -Jm0.5 -R0/50/0/20 -O -P -V -Y10.0 >> test.ps
#
ps2epsi test.ps test.epsi 
convert test.epsi Sa3.png 
/bin/mv Sa3.png ../Mappe/.
rm -f test.epsi
/bin/mv test.ps ../Mappe/Sa3.ps
gzip -f ../Mappe/Sa3.ps
/bin/rm *.grd
/bin/rm pippo* 
#
#gs -sDEVICE=x11 ../Mappe/Sa3.ps
